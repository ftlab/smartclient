...
namespace SmartClient.Core.Controls
{
    public static class TileCustomizer
    {
        public static void CustomiseSmallTile(Tile tile, string caption, Image image)
        {
            ...
            tileItemElement1.Appearance.Normal.Font = new System.Drawing.Font("Segoe UI", 8F);
        ...
        public static void CustomizeMediumTile(Tile tile, string caption, Image image)
        {
            ...
            tileItemElement1.Appearance.Normal.Font = new System.Drawing.Font("Segoe UI", 14F);
            tileItemElement1.Appearance.Normal.Options.UseFont = true;
            tileItemElement1.Image = image;
        ...
        public static void CustomizeWideTile(Tile tile, string caption, Image image)
        {
            ...
            tileItemElement1.Appearance.Hovered.Font = new Font("Segoe UI", 25F);
            ...
            tileItemElement1.Appearance.Normal.Font = new Font("Segoe UI", 25F);
            tileItemElement1.Appearance.Normal.Options.UseFont = true;
            ...
            tileItemElement1.Appearance.Selected.Font = new Font("Segoe UI", 25F);
            ...
            tileItemElement2.Appearance.Hovered.Font = new Font("Segoe UI", 12);
            tileItemElement2.Appearance.Hovered.Options.UseFont = true;
            tileItemElement2.Appearance.Normal.Font = new Font("Segoe UI", 12);
            tileItemElement2.Appearance.Normal.Options.UseFont = true;
            tileItemElement2.Appearance.Selected.Font = new Font("Segoe UI", 12);
            tileItemElement2.Appearance.Selected.Options.UseFont = true;
            tileItemElement2.Image = image ?? Resources.view;
