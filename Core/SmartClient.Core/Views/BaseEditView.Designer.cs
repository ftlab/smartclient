namespace SmartClient.Core.Views
{
    partial class BaseEditView
    {
        ...
        {
            this._okButton = new SmartClient.Core.Controls.FillButton();
            this._cancelButton = new SmartClient.Core.Controls.FillButton();
            this.SuspendLayout();
            // 
            // _okButton
            // 
        ...
        protected SmartClient.Core.Controls.FillButton _okButton;
        protected SmartClient.Core.Controls.FillButton _cancelButton;
    }
}
